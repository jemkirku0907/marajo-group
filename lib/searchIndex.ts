...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  // Disabled Facilities frontend search entry.
  // { title: "Facilities", url: "/facilities", category: "Services", excerpt: "Explore meeting rooms, conference spaces, business facilities, and bookable amenities.", keywords: "court booking facilities sports gym reservation multi-purpose hourly meeting room conference room business lounge" },
