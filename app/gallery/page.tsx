  ...
  return (
    <main className="gallery-page">
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(90deg, rgba(5, 20, 9, 0.38), rgba(5, 20, 9, 0.08) 50%, rgba(5, 20, 9, 0.28)), linear-gradient(180deg, rgba(5, 20, 9, 0.04), rgba(5, 20, 9, 0.3)), url("/assets/Marajo-Share-Social.jpg")',
        }}
      >
