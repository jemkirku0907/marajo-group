...
import { WORKFORCE_TENANT_PORTAL_URL } from "@/lib/externalBooking";
        ...
        <section className="platform-hero">
          <div className="container platform-hero-grid">
            <div>
              ...
              <div className="platform-hero-actions">
                <a href={WORKFORCE_TENANT_PORTAL_URL} target="_blank" rel="noopener noreferrer" className="btn-primary">Log In</a>
              </div>
            </div>
            <div className="platform-preview">
              <img src="/assets/Space-Solution-A.jpg" alt="Marajo office service area" />
