      ...
      <section className="section home-services reveal-on-scroll">
        <div className="container">
          ...
          <div className="home-services-grid">
            <Link href="/parking" className="home-service-card">
            ...
            <Link href="/facilities" className="home-service-card">
              ...
              <div>
                ...
                <p>Reserve a court online. Check live availability, pick your date and time, and get a full fee breakdown before you confirm.</p>
              </div>
              <span className="home-service-link">
                Reserve a court{" "}
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
